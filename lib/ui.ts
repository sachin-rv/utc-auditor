...
export const cardInteractiveClass =
  "border border-line bg-panel rounded-2xl shadow-xl shadow-black/5 dark:shadow-black/40 hover:border-signal-pass/40 hover:shadow-signal-pass/10 transition-shadow";
